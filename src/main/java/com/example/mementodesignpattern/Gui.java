...
public class Gui extends Application {
    ...
    public void start(Stage stage) {
        ...
        button.setOnAction(e -> {
            ...
            VBox vBox = new VBox(new Label("This is a new window"));
            ...
            for (IMemento memento :history) {
                System.out.println("Adding timestamp to list view: " + memento.getTimeStamp());
            ...
            historyStage.setTitle("New Window");
            historyStage.show();
        });
